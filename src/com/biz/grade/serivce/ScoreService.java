...
public class ScoreService {
	...
	// 메뉴에서 수정을 선택했을때 먼저 실행될 updateScore()
	private void updateScore() {
		// TODO 키보드에서 학번을 입력받은 후 updateScore(strNum)에 전달.
		System.out.println("============================");
	...
	// updateScore()와 (업데이트 스코어와) insert 스코어에서 실행할 method();
	private void updateScore(String strNum) {
		// TODO 키보드에서 점수를 입력받고 Dao.Update를 실행
